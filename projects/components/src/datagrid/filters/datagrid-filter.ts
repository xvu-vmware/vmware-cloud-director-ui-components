...
class Base implements ClrDatagridFilterInterface<unknown>, ComponentRenderer<unknown> {
 ...
 */
export abstract class DatagridFilter<V, C extends FilterConfig<V>> extends SubscriptionTrackerMixin(Base) {
    formGroup: FormGroup;
